...
def template_reflow(item_id: str, ctx: Any | None = None) -> str:
    ...
    return _render_template(name="paragraphs", item_id=item_id, ctx=ctx, prompt=prompt)
...
def template_summary(item_id: str, ctx: Any | None = None) -> str:
    ...
    return _render_template(name="summary", item_id=item_id, ctx=ctx, prompt=prompt)
...
def template_outline(item_id: str, ctx: Any | None = None) -> str:
    ...
    return _render_template(name="outline", item_id=item_id, ctx=ctx, prompt=prompt)
...
def template_quotes(item_id: str, ctx: Any | None = None) -> str:
    ...
    return _render_template(name="quotes", item_id=item_id, ctx=ctx, prompt=prompt)
...
def template_faq(item_id: str, ctx: Any | None = None) -> str:
    ...
    return _render_template(name="faq", item_id=item_id, ctx=ctx, prompt=prompt)
...
def template_glossary(item_id: str, ctx: Any | None = None) -> str:
    ...
    return _render_template(name="glossary", item_id=item_id, ctx=ctx, prompt=prompt)
...
def template_action_items(item_id: str, ctx: Any | None = None) -> str:
    ...
    return _render_template(name="action_items", item_id=item_id, ctx=ctx, prompt=prompt)
